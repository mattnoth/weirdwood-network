...
| Class | Script | What it does | Added | How to run |
|-------|--------|--------------|-------|------------|
| C | `graph-query.py` | Read-only graph inspection: node header, outbound/inbound edges, `--neighbors`, `--path`, `--health`, `--event-participants`. | 2026-04-30 | `weirwood graph <args>` |
