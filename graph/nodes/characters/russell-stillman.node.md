---
name: "Russell Stillman"
type: character.human
slug: russell-stillman
aliases: []
confidence: tier-1
...
During [Oakenfist](wiki:Alyn_Velaryon)'s fifth [voyage](wiki:Great_voyages), Russell was knighted by Lord Alyn before losing a leg. He later wrote a book about Lord Alyn Velaryon's life called *[Hard as Oak](wiki:Hard_as_Oak)*. [Archmaester](wiki:Archmaester) [Gyldayn](wiki:Gyldayn) considers this account to be colorful, but unreliable.(wiki:Russell_Stillman.cite_ref-Rfabunder_the_regents_-_the_voyage_of_alyn_oakenfist.7B.7B.7B3.7D.7D.7D.7B.7B.7B4.7D.7D.7D_1-2)
