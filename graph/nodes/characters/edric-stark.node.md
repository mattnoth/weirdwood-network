...
- PARENT_OF (reverse): Alaric Stark → Edric Stark (track_b: Father)
...
No cite_refs; all claims from infobox. Not to be confused with Edric Stark (son of Cregan), a later Stark of the same name.
