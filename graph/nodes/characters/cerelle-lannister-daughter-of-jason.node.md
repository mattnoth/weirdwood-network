---
name: Cerelle Lannister (daughter of Jason)
type: character.human
slug: cerelle-lannister-daughter-of-jason
aliases: []
confidence: tier-1
...
- PARENT_OF: Jason Lannister → Cerelle (cite: track_b: Father) — reverse
- PARENT_OF: Johanna Westerling → Cerelle (cite: track_b: Mother) — reverse
- SIBLING_OF: Tyshara Lannister (cite: wiki:Cerelle_Lannister_(daughter_of_Jason))
- SIBLING_OF: Loreon Lannister (cite: wiki:Cerelle_Lannister_(daughter_of_Jason))

## Notes

Source is Fire & Blood only. Historical character, no main series appearances.
