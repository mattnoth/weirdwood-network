...
- PARENT_OF: Turnip (track_b: Issue)
- LOVER_OF: Osha (track_b: Lover)
- SWORN_TO: House Stark (track_b: Allegiance)
- CULTURE_OF: Northmen (track_b: Culture)
- SERVES: House Stark (wiki:Gage)

## Notes

cite_refs span AGOT (8, 53, 70) and ACOK (4, 16, 46, 51, 66). The TWOW sample chapter reference is provisional — the book is unpublished (Tier 2 — wiki cites a released sample chapter).
