...
slug: aegon-targaryen-young-griff
aliases:
  - "Young Griff"
  - "Aegon VI"
confidence: tier-1
...
- SWORN_TO: House Targaryen (qualifier: supposedly) (cite: track_b: Allegiance)
- HOLDS_TITLE: Prince (qualifier: supposedly) (cite: track_b: Titles)
- HOLDS_TITLE: King of the Andals, the Rhoynar, and the First Men (qualifier: claimant) (cite: track_b: Titles)
- CULTURE_OF: Valyrian (cite: track_b: Race)
- PARENT_OF (reverse): Elia Martell (qualifier: supposedly) (cite: track_b: Mothers)
- BORN_AT: Dragonstone (qualifier: supposedly) (cite: track_b: Born)

## Notes

Tier 2 (disputed identity): The wiki explicitly states "it is unconfirmed whether this character and Aegon Targaryen (son of Rhaegar) are the same person." His true identity is one of the major unresolved questions in the series. The `first_available` from the parser (AGOT ch 3) likely refers to mentions of the baby Aegon (son of Rhaegar) rather than Young Griff specifically; Young Griff as a character appears only in ADWD.
