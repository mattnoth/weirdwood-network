...
- SPOUSE_OF: Teora Kyndall (cite: track_b_row.relationships.Spouse)
- PARENT_OF: Cerelle Lannister (cite: track_b_row.relationships.Issue)
- PARENT_OF (reverse): Damon Lannister (cite: track_b_row.relationships.Father)
- PARENT_OF (reverse): Cerissa Brax (cite: track_b_row.relationships.Mother)
