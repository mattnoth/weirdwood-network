...
- SWORN_TO: the Citadel (cite: track_b: Allegiances)
- SWORN_TO: House Martell (cite: track_b: Allegiances)
- HOLDS_TITLE: Maester at Sunspear (cite: track_b: Title)
- CULTURE_OF: Westerosi (cite: track_b: Culture)
- SERVES: Doran Martell (cite: wiki:Myles)
- LOCATED_AT: Sunspear (cite: wiki:Myles)
