...
- SPOUSE_OF: Jeyne Marbrand (cite: track_b_row.relationships.Spouse)
- LOVER_OF: First mistress (cite: track_b_row.relationships.Lovers)
- LOVER_OF: Second mistress (cite: track_b_row.relationships.Lovers)
- PARENT_OF: Tywin Lannister (cite: track_b_row.relationships.Issue)
- PARENT_OF: Kevan Lannister (cite: track_b_row.relationships.Issue)
- PARENT_OF: Genna Lannister (cite: track_b_row.relationships.Issue)
- PARENT_OF: Tygett Lannister (cite: track_b_row.relationships.Issue)
- PARENT_OF: Gerion Lannister (cite: track_b_row.relationships.Issue)
- PARENT_OF (reverse): Gerold Lannister (cite: track_b_row.relationships.Father)
- PARENT_OF (reverse): Rohanne Webber (cite: track_b_row.relationships.Mother)
- SIBLING_OF: Tywald Lannister (cite: wiki:Tytos_Lannister)
- SIBLING_OF: Tion Lannister (cite: wiki:Tytos_Lannister)
- SIBLING_OF: Jason Lannister (cite: wiki:Tytos_Lannister)
- DIED_AT: Casterly Rock (cite: track_b_row.relationships.Died)
