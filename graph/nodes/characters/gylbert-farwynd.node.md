...
slug: gylbert-farwynd
aliases: []
confidence: tier-1
wiki_source: "https://awoiaf.westeros.org/index.php/Gylbert_Farwynd"
...
Gylbert Farwynd is a character.human from the AWOIAF wiki.
...
- BORN_AT: Lonely Light (track_b: Born)
- PARENT_OF: Gyles Farwynd (track_b: Issue)
- PARENT_OF: Ygon Farwynd (track_b: Issue)
- PARENT_OF: Yohn Farwynd (track_b: Issue)
