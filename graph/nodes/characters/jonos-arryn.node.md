...
- PARENT_OF (reverse): Sharra Arryn (track_b: Mother)
- SIBLING_OF: Ronnel Arryn (wiki:Jonos_Arryn)
- SWORN_TO: House Arryn (track_b: Allegiance)
- CULTURE_OF: Valemen (track_b: Culture)
- HOLDS_TITLE: Prince (track_b: Titles) [pre-Conquest]
- CLAIMS: King of Mountain and Vale (track_b: Titles)
- KILLS: Ronnel Arryn (wiki:Jonos_Arryn) [threw through Moon Door]
- DIED_AT: Eyrie (track_b: Died)
- BETRAYS: Ronnel Arryn (wiki:Jonos_Arryn) [kinslaying]
