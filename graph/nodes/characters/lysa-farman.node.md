...
aliases: []
confidence: tier-1
wiki_source: "https://awoiaf.westeros.org/index.php/Lysa_Farman"
...
Lysa Farman is a character.human from the AWOIAF wiki.

## Edges

- SWORN_TO: House Farman (track_b: Allegiances)
- SWORN_TO: House Greyjoy (track_b: Allegiances) [forcibly]
- SWORN_TO: House Goodbrother (track_b: Allegiances) [forcibly]
- CULTURE_OF: Westermen (track_b: Culture)
- PARENT_OF (reverse): Farman (track_b: Father)
- SPOUSE_OF: Dalton Greyjoy (track_b: Spouses) [as a salt wife]
- SPOUSE_OF: salt wife (track_b: Spouses) [as a salt wife]
- SPOUSE_OF: Gunthor Goodbrother (track_b: Spouses) [as a salt wife]
