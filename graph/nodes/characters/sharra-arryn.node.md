...
- PARENT_OF: Ronnel Arryn (track_b: Issue)
- PARENT_OF: Jonos Arryn (track_b: Issue)
- SWORN_TO: House Arryn (track_b: Allegiance)
- CULTURE_OF: Valemen (track_b: Culture)
- HOLDS_TITLE: Queen (track_b: Title) [Regent of the Kingdom of Mountain and Vale]
- RULES: Vale of Arryn (wiki:Sharra_Arryn) [as regent for Ronnel]
