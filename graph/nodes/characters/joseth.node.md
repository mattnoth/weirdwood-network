...
- HOLDS_TITLE: master of horse (cite: track_b_row.relationships.title)
- PARENT_OF: Bandy (cite: track_b: Issue)
- PARENT_OF: Shyra (cite: track_b: Issue)
- DIED_AT: Winterfell (cite: track_b: Died)

## Notes

Died 299 AC (track_b: Died). Death at Winterfell is marked as unconfirmed in track_b. Tier 2 (inference): the wiki states he "likely died" during the sack, not confirmed.
