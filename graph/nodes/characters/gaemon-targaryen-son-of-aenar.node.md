---
name: Gaemon Targaryen (son of Aenar)
type: character.human
slug: gaemon-targaryen-son-of-aenar
aliases:
  - Gaemon the Glorious
confidence: tier-1
...
- HOLDS_TITLE: Lord of Dragonstone (cite: track_b_row.relationships.Title)
...
- PARENT_OF (reverse): Aenar Targaryen is parent (cite: track_b_row.relationships.Father)
- SPOUSE_OF: Daenys Targaryen (cite: track_b_row.relationships.Spouse)
- PARENT_OF: Aegon Targaryen (cite: track_b_row.relationships.Issue)
