...
- SERVES: Cregan Stark (cite: wiki:Kennet_(maester))

## Notes

No cite_refs available; all information sourced from *The World of Ice & Fire*. `first_available` absent from track_b — omitted per v1 rules.
