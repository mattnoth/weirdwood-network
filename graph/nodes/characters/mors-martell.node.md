...
- HOLDS_TITLE: Lord of the Sandship (cite: track_b: Titles)
...
- SPOUSE_OF: Nymeria (cite: track_b: Spouse)
- PARENT_OF: Four daughters (cite: track_b: Issue)
- DIED_AT: the Boneway (cite: track_b: Died)
- KILLS: (reverse) Killed by Yorick V Yronwood (cite: wiki:Mors_Martell)

## Notes

Known from TWOIAF, AGOT, and AFFC (all "mentioned"). The 1st Prince of Dorne.
