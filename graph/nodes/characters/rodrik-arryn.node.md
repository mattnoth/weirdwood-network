...
- PARENT_OF (reverse): Rymond Arryn (track_b: Father)
- SPOUSE_OF: Daella Targaryen (track_b: Spouses)
- PARENT_OF: Elys Arryn (track_b: Issue)
- PARENT_OF: Amanda Arryn (track_b: Issue)
...
- ADVISES: Jaehaerys I Targaryen (wiki:Rodrik_Arryn) [small council member]
