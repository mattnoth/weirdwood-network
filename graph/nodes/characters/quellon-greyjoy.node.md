...
>
> —thoughts of Aeron Greyjoy, AFFC (`sources/chapters/affc/affc-the-prophet-01.md:93`)
...
>
> —thoughts of Aeron Greyjoy, AFFC (`sources/chapters/affc/affc-the-prophet-01.md:159`)
...
- PARENT_OF (reverse): Dagon Greyjoy (cite: track_b: Father)
- SPOUSE_OF: Lady Stonetree (cite: track_b: Spouses)
- SPOUSE_OF: Lady Sunderly (cite: track_b: Spouses)
- SPOUSE_OF: Lady Piper (cite: track_b: Spouses)
- PARENT_OF: Harlon Greyjoy (cite: track_b: Issue)
- PARENT_OF: Quenton Greyjoy (cite: track_b: Issue)
- PARENT_OF: Donel Greyjoy (cite: track_b: Issue)
- PARENT_OF: Balon Greyjoy (cite: track_b: Issue)
- PARENT_OF: Euron Greyjoy (cite: track_b: Issue)
- PARENT_OF: Victarion Greyjoy (cite: track_b: Issue)
- PARENT_OF: Urrigon Greyjoy (cite: track_b: Issue)
- PARENT_OF: Aeron Greyjoy (cite: track_b: Issue)
- PARENT_OF: Robin Greyjoy (cite: track_b: Issue)
- DIED_AT: mouth of the Mander (cite: track_b: Died)

## Notes

Tier 1 (override up from parser): Parser first_available listed AFFC 1, but cite_refs show ACOK chapter 11 — character is mentioned earlier. Set first_available to "always available"; question filed.
