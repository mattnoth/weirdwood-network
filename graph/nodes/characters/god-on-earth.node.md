...
slug: god-on-earth
aliases: ["God-on-Earth"]
confidence: tier-1
wiki_source: "https://awoiaf.westeros.org/index.php/God-on-Earth"
...
God-on-Earth is a character.human from the AWOIAF wiki.

## Edges

- HOLDS_TITLE: God-Emperor (track_b: Title)
- SUCCEEDS (reverse): None (track_b: Predecessor)
- HEIR_TO: Pearl Emperor (track_b: Heir)
- SUCCEEDS: Pearl Emperor (track_b: Successor)
- CULTURE_OF: Great Empire of the Dawn (track_b: Culture)
- PARENT_OF: Pearl Emperor (track_b: Issue)
- PARENT_OF (reverse): Lion of Night (track_b: Father)
- PARENT_OF (reverse): Maiden-Made-of-Light (track_b: Mother)
