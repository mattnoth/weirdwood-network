...
- HOLDS_TITLE: True Heart (track_b: Titles)
...
- DIED_AT: Stepstones (track_b: Died) [133 AC]
- PARENT_OF (reverse): Vaemond Velaryon (track_b: Father)
- SPOUSE_OF: Hazel Harte (track_b: Spouse)
