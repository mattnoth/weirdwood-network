...
- DIED_AT: Fair Isle (track_b: Died) [50 AC]
- PARENT_OF (reverse): Lord Farman (track_b: Father)
- PARENT_OF: Franklyn Farman (track_b: Issue)
- PARENT_OF: Elissa Farman (track_b: Issue)
- PARENT_OF: Androw Farman (track_b: Issue)
