...
- CULTURE_OF: Summer Islander (cite: track_b: Race)
- PARENT_OF: (reverse) Father is Oberyn Martell (cite: track_b: Father)
- PARENT_OF: (reverse) Mother is a Summer Islander captain (cite: track_b: Mother)
- SIBLING_OF: Obara Sand, Nymeria Sand, Tyene Sand, Elia Sand, Obella Sand, Dorea Sand, Loreza Sand (cite: wiki:Sarella_Sand)
