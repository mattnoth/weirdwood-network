...
slug: brandon-stark-son-of-cregan
aliases: []
confidence: tier-1
...
- PARENT_OF (reverse): Cregan Stark → Brandon Stark (track_b: Father)
- PARENT_OF (reverse): Lynara Stark → Brandon Stark (track_b: Mother)
- SPOUSE_OF: Alys Karstark (track_b: Spouse)
- PARENT_OF: Rodwell Stark (track_b: Issue)
- PARENT_OF: Beron Stark (track_b: Issue)
- PARENT_OF: Arsa Stark (track_b: Issue)
- PARENT_OF: Lonnel Snow (track_b: Issue)
...
Born between 140–183 AC; the wide range reflects uncertainty in wiki sources (track_b: Born). Lonnel Snow was a bastard son (track_b: Issue).
