---
name: Rickon Stark (son of Cregan)
type: character.human
slug: rickon-stark-son-of-cregan
aliases: []
confidence: tier-1
...
- PARENT_OF: Cregan Stark → Rickon Stark (cite: track_b: Father)
- PARENT_OF: Arra Norrey → Rickon Stark (cite: track_b: Mother)
- SPOUSE_OF: Jeyne Manderly (cite: track_b: Spouse)
- PARENT_OF: Rickon Stark → Sansa Stark (cite: track_b: Issue)
- PARENT_OF: Rickon Stark → Serena Stark (cite: track_b: Issue)
