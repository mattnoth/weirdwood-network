---
name: "Willam Stackspear"
type: character.human
slug: willam-stackspear
aliases: []
confidence: tier-1
wiki_source: "https://awoiaf.westeros.org/index.php/Willam_Stackspear"
...
Willam Stackspear is a character.human from the AWOIAF wiki.
...
During the [Great Council](wiki:Great_Council) of [136 AC](wiki:136_AC), three [regents](wiki:Regent) were selected by lot to serve in the [regency](wiki:Regency_of_Aegon_III) for King [Aegon III Targaryen](wiki:Aegon_III_Targaryen).(wiki:Willam_Stackspear.cite_ref-Rtwoiafthe_targaryen_kings:_aegon_iii.7B.7B.7B3.7D.7D.7D.7B.7B.7B4.7D.7D.7D_2-1) Lord Willam Stackspear was among the three regents selected, considered an inoffensive, though undistinguished, choice.(wiki:Willam_Stackspear.cite_ref-Rfabthe_lysene_spring_and_the_end_of_regency.7B.7B.7B3.7D.7D.7D.7B.7B.7B4.7D.7D.7D_1-4)
