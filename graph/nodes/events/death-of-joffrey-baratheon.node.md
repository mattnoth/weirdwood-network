...
— Tyrion Lannister POV, ASOS Tyrion VIII (`sources/chapters/asos/asos-tyrion-08.md:301`) — book-cite overlay (S134 harvest-consume); the physical description of Joffrey's death by the Strangler

> "No. For that, you must turn to a rarer poison. When I was a boy at the Citadel, my teachers named it simply the strangler."

— Grand Maester Pycelle testifying at Tyrion's trial, ASOS Tyrion IX (`sources/chapters/asos/asos-tyrion-09.md:251`) — book-cite overlay (S134 harvest-consume); names the poison at trial; line confirmed at :251 (queue suggested :243 as possible alternative but :251 is correct)
