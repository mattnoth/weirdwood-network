---
name: "Marshall of the Northmarch"
type: title
slug: marshall-of-the-northmarch
aliases: []
confidence: tier-2
wiki_source: "https://awoiaf.westeros.org/index.php/Marshall_of_the_Northmarch"
...
Eustace claimed it was the [Field of Fire](wiki:Field_of_Fire) during [Aegon's Conquest](wiki:Aegon's_Conquest) where the Osgreys began to dwindle and diminish, until they were no more than [landed knights](wiki:Landed_knight) bound in fealty to [House Rowan](wiki:House_Rowan).(wiki:Marshall_of_the_Northmarch.cite_ref-Rtss.7B.7B.7B2.7D.7D.7D.7B.7B.7B3.7D.7D.7D.7B.7B.7B4.7D.7D.7D_1-3)

## Quotes

For a thousand years before [the Conquest](wiki:Aegon's_Conquest), we were the Marshalls of the Northmarch. A score of lesser [lordlings](wiki:Lord) did us fealty, and a hundred [landed knights](wiki:Landed_knight).(wiki:Marshall_of_the_Northmarch.cite_ref-Rtss.7B.7B.7B2.7D.7D.7D.7B.7B.7B3.7D.7D.7D.7B.7B.7B4.7D.7D.7D_1-4)
