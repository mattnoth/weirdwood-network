...
aliases: []
confidence: tier-2
wiki_source: "https://awoiaf.westeros.org/index.php/True_Heart"
...
True Heart is an artifact (named weapon, ship, or object) from the AWOIAF wiki.
...
While [Lord Alyn's attack](wiki:Lord_Alyn's_attack) against the [Braavosi](wiki:Braavos) fleet was complete, he did lose three ships in the Stepstones, amongst them the True Heart with his cousin, [Daeron Velaryon](wiki:Daeron_Velaryon).(wiki:True_Heart.cite_ref-Rfabunder_the_regents_-_war_and_peace_and_cattle_shows.7B.7B.7B3.7D.7D.7D.7B.7B.7B4.7D.7D.7D_1-2)
