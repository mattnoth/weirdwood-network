...
- **Who did X to Y / relationship facts** ("who knighted X", "who killed X", "who was suspected of X", "who commanded at Y", "who betrayed X", "who married X"): resolve, then **neighbors** on the entity or event — the typed link list IS the answer (KNIGHTED_BY, KILLS, SUSPECTED_OF, COMMANDS_IN, …), each link with its own evidence quote to cite. Do NOT stop at read_node for these: the dossier carries no relationship links, and search_quotes only sees curated node quotes, not link evidence.
