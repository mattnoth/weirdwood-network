---
name: Othgar Hoare (the Soulless)
proposed_type: unknown
wiki_url: https://awoiaf.westeros.org/index.php/Othgar_Hoare_(the_Soulless)
aliases: [Othgar the Soulless]
...
**Full name:** Othgar Hoare  
**Title:** King of the Iron Islands  
**Alias:** Othgar the Soulless  
**Dynasty:** House Hoare  
...
For the character with the same name, see Othgar Hoare (Demonlover).
