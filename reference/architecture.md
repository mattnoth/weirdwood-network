...
**Qualifier enums for Tier-1/Tier-2 edge types:** see `reference/edge-qualifier-vocab.md`. Eight types require a `qualifier` field (Tier 1: SIBLING_OF, SPOUSE_OF, PARENT_OF, WARD_OF, HOLDS_TITLE, VOWS_TO, MANIPULATES, SWORN_TO); ten types allow an optional qualifier (Tier 2: BETROTHED_TO, LOVER_OF, KILLS, CONTRACTED_WITH, DECEIVES, REVEALS_TO, ATTACKS, KNOWS, GUEST_OF, IN_LAW_OF). All other edge types must NOT carry a `qualifier` field.
