...
- Added worklog archival rule: when the session log exceeds ~150 lines, older sessions get archived to `history/worklog-archives/`
- Archived Sessions 0-4 to `history/worklog-archives/archive001.md`
