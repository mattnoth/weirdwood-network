...
**IN FLIGHT**
- (none — S113 J3 batch complete, awaiting Matt's commit OK.) **S113 minted WO5K decomposition #1 (J3 Robb-proclaimed-King-in-the-North): 1 beat + 3 edges (2 causal Tier-2 fresh-subagent CONFIRMED + 1 Tier-1 role). `execution-of-eddard-stark` 0→2 downstream causal; extends the B3 Ned's-downfall chain one hop. Plus the S109 spaced-alias fix on both Bran nodes (`jaime-pushes-bran-from-the-tower` +"bran's fall"; `bran-witnesses-jaime-and-cersei` +spaced).** Dip-driven cadence held — one juncture, no mass-mint.
...
- **NEXT (Matt's steer S113): AFFC smoke test FIRST** — causal layer has ~zero AFFC/ADWD coverage; run the Loremaster demo / arc-dip against AFFC arc-queries (Cersei's downfall, Brienne→Stoneheart, Kingsmoot→Euron, Dorne/Myrcella, Greyjoy/Reach) to surface dark AFFC arcs and re-prioritize. Read-only dip-as-check; **may bump Q5**. Then build the top fumble.
- **NEXT BUILD (after the smoke test): WO5K junctures from `working/wo5k-decomposition.md`, one at a time, dip-gated. #1 J3 DONE (S113).** Default next = **Rank 2 / Q5: `storming-of-the-crag CAUSES robb-weds-jeyne-westerling`** (dedup-check `battle-of-the-crag` vs `storming-of-the-crag` FIRST; likely 1-edge wire + maybe 1 mint; theory-loaded Sybell-Spicer/moon-tea reading — Matt flagged do-not-lose). Subsequent ranking: #3 Blackwater-upstream (J2+J9: Renly→Stannis→Tyrell-realignment, 3–4 mints — highest salience) · #4 Karstark→Robb-isolation (J7) · #5 Balon→Winterfell (J4). SKIP the westerlands battle sequence (pure PRECEDES, J6).
...
> archive023 = S107–S108 (FILLING, 2/5) · archive022 = S102–S106 (FULL) · archive021 = S97–S101 (FULL) · archive020 = S92–96 · archive019 = S87–S91 · archive018 = S83(×2: /tmp-paths + Plates 0-2)–S86 · archive017 = S78–82 · archive016 = S73–77 · archive015 = S68–72
