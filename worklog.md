...
**IN FLIGHT**
- (none — S114 AFFC smoke test + Cersei's-downfall arc complete, committed this endsession.) **S114 ran the AFFC smoke test (all 5 AFFC arc-clusters causally dark; ranked fumble list) and built its #1: the Cersei's-downfall arc — 2 beats + 10 edges (5 causal Tier-2 fresh-subagent CONFIRMED + 5 role Tier-1); first AFFC causal arc, layer no longer 100% dark.** Dip-as-check held — smoke test ranks, no re-discovery dip.
...
- **NEXT BUILD (S114 endsession, orchestrator's pick): AFFC #3 Brienne → Lady Stoneheart** — roots cleanly at the already-built `red-wedding` (best cross-book auto-join). Needs mints: a Stoneheart-reveal beat (Beric resurrects Catelyn) + Brienne-captured-by-the-BWB beat (note the `brienne-arrested` TRAP = ASOS Harrenhal, NOT this). Then re-check + harvest-consume. **Remaining AFFC queue:** #2 Kingsmoot→Euron (standalone, needs `death-of-balon` + `euron-wins` mints + retype `kingsmoot-on-old-wyk` event.battle→event.ceremony) · #4 Dorne/Myrcella. **Secondary cheap dip Q5** (`storming-of-the-crag CAUSES robb-weds-jeyne-westerling`, ASOS; dedup-check `battle-of-the-crag` first; theory-loaded Sybell-Spicer/moon-tea — do-not-lose) still queued. WO5K junctures (#3 Blackwater-upstream J2+J9 · #4 Karstark J7 · #5 Balon→Winterfell J4) in `working/wo5k-decomposition.md`.
...
> archive023 = S107–S109 (FILLING, 3/5) · archive022 = S102–S106 (FULL) · archive021 = S97–S101 (FULL) · archive020 = S92–96 · archive019 = S87–S91 · archive018 = S83(×2: /tmp-paths + Plates 0-2)–S86 · archive017 = S78–82 · archive016 = S73–77 · archive015 = S68–72
