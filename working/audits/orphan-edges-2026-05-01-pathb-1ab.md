# Orphan Edges Audit — 2026-05-01-pathb-1ab

**Nodes scanned:** 5291
**Total edges checked:** 19059
**Edges that resolve cleanly:** 15806
**Orphan / problematic edges found:** 3253

**Breakdown:**
- Category 1 (target genuinely missing): 2941 edges across 1162 unique missing targets
...
Sorted by `in_count` desc, then by edge_count. Top 100 of 1162 unique missing targets shown.
...
| 7 | `red-fork` | 4 | 64 |  | `hoster-tully` / BURIED_AT / Red Fork |
| 8 | `house-manderly` | 24 | 61 |  | `bartimus` / SWORN_TO / House Manderly |
| 9 | `dragonpit` | 6 | 60 |  | `burning-knight` / DIED_AT / Dragonpit (track_b: Died) |
| 10 | `harren-hoare` | 3 | 56 |  | `halleck-hoare` / HEIR_TO / Harren Hoare |
| 11 | `maegors-holdfast` | 3 | 56 |  | `aegon-targaryen-son-of-rhaegar` / DIED_AT / Maegor's Holdfast (qualifier: supposedly) |
| 12 | `kingswood` | 3 | 55 |  | `simon-toyne` / DIED_AT / Kingswood (track_b: Died) |
| 13 | `haunted-forest` | 2 | 55 |  | `clubfoot-karl` / DIED_AT / Haunted forest (track_b: Died) |
| 14 | `starry-sept` | 3 | 53 |  | `high-lickspittle` / DIED_AT / Starry Sept (track_b: Died) |
| 15 | `disputed-lands` | 6 | 52 |  | `aegor-rivers` / DIED_AT / Disputed Lands (track_b: Died) |
| 16 | `blackwater-bay` | 6 | 50 |  | `allard-seaworth` / DIED_AT / Blackwater Bay (track_b: Died) |
| 17 | `neck` | 3 | 50 |  | `coming-of-the-andals` / DEFEATS / Neck |
| 18 | `red-mountains` | 1 | 50 |  | `vulture-king-jaehaerys-i` / DIED_AT / Red Mountains (track_b: Died) |
| 19 | `house-blackwood` | 30 | 46 |  | `agnes-blackwood` / SWORN_TO / House Blackwood |
| 20 | `iron-bank-of-braavos` | 2 | 46 |  | `noho-dimittis` / SWORN_TO / Iron Bank of Braavos |
| 21 | `house-bracken` | 24 | 45 |  | `aegor-rivers` / SWORN_TO / House Bracken |
| 22 | `wolfswood` | 2 | 45 |  | `harwood-fell` / DIED_AT / Wolfswood (track_b: Died) |
| 23 | `sunset-sea` | 1 | 45 |  | `norman-hightower` / DIED_AT / Sunset Sea (track_b: Died) |
| 24 | `mountains-of-the-moon` | 13 | 44 |  | `chiggen` / DIED_AT / Mountains of the Moon (track_b: Died) |
| 25 | `fair-isle` | 6 | 44 |  | `arron` / BORN_AT / Fair Isle |
| 26 | `stoney-sept` | 6 | 44 |  | `bella` / BORN_AT / Stoney Sept (track_b: Born) |
| 27 | `queens-men` | 18 | 43 |  | `alester-florent` / SWORN_TO / Queen's men |
| 28 | `old-wyk` | 6 | 41 |  | `baelor-blacktyde` / DIED_AT / Old Wyk (track_b: Died) |
| 29 | `crossroads-inn` | 1 | 39 |  | `wat-orphan` / SWORN_TO / Crossroads inn |
| 30 | `tarth` | 6 | 37 |  | `aemon-targaryen-son-of-jaehaerys-i` / DIED_AT / Tarth |
| 31 | `dornish-marches` | 4 | 36 |  | `anguy` / BORN_AT / Dornish Marches |
| 32 | `three-sisters` | 4 | 36 |  | `lark` / BORN_AT / Three Sisters |
| 33 | `dothraki-sea` | 19 | 35 |  | `caggo` / BORN_AT / Dothraki Sea |
| 34 | `house-rogare` | 12 | 35 |  | `drako-rogare` / SWORN_TO / House Rogare |
| 35 | `khal` | 22 | 34 | yes | `bharbo` / HOLDS_TITLE / Khal |
| 36 | `house-darry` | 16 | 34 |  | `damon-darry` / SWORN_TO / House Darry |
| 37 | `century-of-blood` | 3 | 34 |  | `agnes-blackwood` / DIED_AT / Century of Blood |
| 38 | `tower-of-the-hand` | 2 | 34 |  | `jaehaerys-targaryen-son-of-aegon-ii` / DIED_AT / Tower of the Hand (track_b: Died) |
| 39 | `great-pyramid` | 1 | 34 |  | `house-targaryen` / SEAT_OF / Great Pyramid |
| 40 | `house-florent` | 18 | 33 |  | `aladore-florent` / SWORN_TO / House Florent |
| 41 | `crackclaw-point` | 5 | 33 |  | `dick-crabb` / BORN_AT / Crackclaw Point |
| 42 | `dragons` | 1 | 32 |  | `dance-of-the-dragons` / DEFEATS / dragons |
| 43 | `fingers` | 5 | 31 |  | `petyr-baelish` / BORN_AT / Fingers (track_b: Born) |
| 44 | `flea-bottom` | 5 | 30 |  | `clayton-suggs` / BORN_AT / Flea Bottom |
| 45 | `faircastle` | 3 | 30 |  | `alester-wynch` / DIED_AT / Faircastle (track_b: Died) |
| 46 | `crypt-of-winterfell` | 14 | 29 |  | `barthogan-stark` / BURIED_AT / Crypt of Winterfell |
| 47 | `runestone` | 6 | 29 |  | `andar-royce` / BORN_AT / Runestone |
| 48 | `house-durrandon` | 5 | 29 |  | `argella-durrandon` / SWORN_TO / House Durrandon |
| 49 | `daznaks-pit` | 1 | 29 |  | `yurkhaz-zo-yunzak` / DIED_AT / Daznak's Pit (track_b: Died) |
| 50 | `ruby-ford` | 1 | 29 |  | `rhaegar-targaryen` / DIED_AT / Ruby Ford (track_b: Died) |
| 51 | `rhoynar` | 11 | 28 |  | `druselka` / SWORN_TO / Rhoynar |
| 52 | `lords-declarant` | 7 | 27 |  | `anya-waynwood` / SWORN_TO / Lords Declarant |
| 53 | `house-cerwyn` | 6 | 27 |  | `argelle-stark` / SWORN_TO / House Cerwyn |
| 54 | `jeyne-arryn` | 4 | 27 |  | `arnold-arryn` / OPPOSES / Jeyne Arryn (wiki:Arnold_Arryn) |
| 55 | `green-fork` | 3 | 27 |  | `conn` / DIED_AT / Green Fork (track_b: Died) |
| 56 | `bear-island` | 9 | 26 |  | `alysane-mormont` / BORN_AT / Bear Island (track_b: Born) |
| 57 | `giants-lance` | 4 | 26 |  | `artys-i-arryn` / BORN_AT / Giant's Lance |
| 58 | `silent-sisters` | 4 | 26 |  | `alysanne-osgrey` / SWORN_TO / Silent Sisters |
| 59 | `arlan-of-pennytree` | 1 | 26 |  | `chestnut` / OWNS / Arlan of Pennytree |
| 60 | `ship` | 1 | 26 |  | `quence` / SWORN_TO / Ship |
| 61 | `larys-strong` | 1 | 25 |  | `hour-of-the-wolf` / DEFEATS / Larys Strong |
| 62 | `house-gardener` | 10 | 24 |  | `alester-tyrell` / SWORN_TO / House Gardener |
| 63 | `stormcrows` | 7 | 24 |  | `daario-naharis` / SWORN_TO / Stormcrows |
| 64 | `oldstones` | 5 | 24 |  | `merrett-frey` / DIED_AT / Oldstones (track_b: Died) |
| 65 | `shipbreaker-bay` | 4 | 24 |  | `arrax` / DIED_AT / Shipbreaker Bay (track_b: Died) |
| 66 | `house-of-black-and-white` | 2 | 24 |  | `umma` / SWORN_TO / House of Black and White |
| 67 | `299-ac` | 1 | 24 |  | `house-bolton` / OVERLORD_OF / 299 AC (track_b: Overlords) |
| 68 | `betrothal` | 1 | 24 |  | `lyonel-baratheons-rebellion` / DEFEATS / Betrothal |
| 69 | `house-hornwood` | 7 | 23 |  | `berena-hornwood` / SWORN_TO / House Hornwood |
| 70 | `house-dustin` | 6 | 23 |  | `barbrey-dustin` / SWORN_TO / House Dustin |
| 71 | `shield-islands` | 4 | 23 |  | `talbert-serry` / DIED_AT / Shield Islands (track_b: Died) |
| 72 | `marwyn` | 1 | 23 |  | `qyburn` / RESPECTS / Marwyn |
| 73 | `joffrey-i-baratheon` | 2 | 22 |  | `robert-i-baratheon` / SUCCEEDS / Joffrey I Baratheon |
| 74 | `hugh-hammer` | 1 | 22 |  | `vermithor` / OWNS / Hugh Hammer |
| 75 | `crag` | 8 | 21 |  | `eleyna-westerling` / BORN_AT / Crag (track_b: Born) |
| 76 | `stone-hedge` | 6 | 21 |  | `hendry-bracken` / DIED_AT / Stone Hedge (track_b: Died) |
| 77 | `vale` | 5 | 21 |  | `battle-in-the-waters-off-gulltown` / DEFEATS / Vale |
| 78 | `greyguard` | 1 | 21 |  | `jarl` / DIED_AT / Greyguard (track_b: Died) |
| 79 | `torrhens-square` | 4 | 20 |  | `helman-tallhart` / BORN_AT / Torrhen's Square |
| 80 | `aegonfort` | 1 | 20 |  | `house-targaryen` / SEAT_OF / Aegonfort (track_b: Seats) |
| 81 | `chequy-water` | 1 | 20 |  | `lucas-inchfield` / DIED_AT / Chequy Water (track_b: Died) |
| 82 | `greenblood` | 1 | 20 |  | `arys-oakheart` / DIED_AT / Greenblood (track_b: Died) |
| 83 | `northern-mountains` | 1 | 20 |  | `house-wull` / SEAT_OF / Northern mountains |
| 84 | `house-glover` | 13 | 19 |  | `benton-glover` / SWORN_TO / House Glover |
| 85 | `house-lothston` | 11 | 19 |  | `bastard-of-harrenhal` / SWORN_TO / House Lothston |
| 86 | `gift` | 5 | 19 |  | `sylas-the-grim` / DIED_AT / Gift (track_b: Died) |
| 87 | `cinnamon-wind` | 2 | 19 |  | `aemon-targaryen-son-of-maekar-i` / DIED_AT / Cinnamon Wind |
| 88 | `wise-masters` | 15 | 18 |  | `beastmaster` / SWORN_TO / Wise Masters |
| 89 | `helaena-targaryen` | 5 | 18 |  | `alicent-hightower` / PARENT_OF / Helaena Targaryen |
| 90 | `claw-isle` | 3 | 18 |  | `ardrian-celtigar` / BORN_AT / Claw Isle (track_b: Born) |
| 91 | `great-wyk` | 3 | 18 |  | `leo-costayne` / DIED_AT / Great Wyk (track_b: Died) |
| 92 | `tower-of-joy` | 1 | 18 |  | `roberts-rebellion` / FIGHTS_IN / Tower of joy |
| 93 | `quiet-isle` | 5 | 17 |  | `clement` / SWORN_TO / Quiet Isle |
| 94 | `andal-invasion` | 3 | 17 |  | `battle-of-the-seven-stars` / FIGHTS_IN / Andal invasion |
| 95 | `hellholt` | 2 | 17 |  | `rhaenys-targaryen` / DIED_AT / Hellholt (track_b: Died) |
| 96 | `long-night` | 1 | 17 |  | `battle-for-the-dawn` / DEFEATS / Long Night |
| 97 | `white-knife` | 1 | 17 |  | `chayle` / BORN_AT / White Knife |
| 98 | `lads` | 3 | 16 |  | `alysanne-blackwood` / SWORN_TO / Lads |
| 99 | `282-ac` | 1 | 16 |  | `house-baratheon` / OVERLORD_OF / 282 AC (track_b: Overlords) |
| 100 | `basilisk-isles` | 1 | 16 |  | `tumco-lho` / BORN_AT / Basilisk Isles (track_b: Born) |

_(Long tail: 1062 additional missing targets. See `working/audits/orphan-edges-2026-05-01-pathb-1ab-cat1-full.tsv` for the complete list.)_
...
Of 19059 edges across 5291 nodes, 15806 resolve cleanly. 3253 are orphan or stale, dominated by Cat 1 (2941 edges, 1162 unique slugs). Date-bleed status: 42 stragglers remain. Religion-bleed leftovers: 0. Title-like targets are a structural gap: 21 title slugs referenced by 68 edges with no node. Cat 2 alias-mismatches (270 edges) are not gaps — they're handled the moment the graph layer consults `working/wiki-parsed/alias-resolver.json` after a direct-slug miss.
