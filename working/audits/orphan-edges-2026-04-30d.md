# Orphan Edges Audit — 2026-04-30d

**Nodes scanned:** 4758
**Total edges checked:** 18635
**Edges that resolve cleanly:** 15105
**Orphan / problematic edges found:** 3530

**Breakdown:**
- Category 1 (target genuinely missing): 3419 edges across 1359 unique missing targets
...
Sorted by `in_count` desc, then by edge_count. Top 100 of 1359 unique missing targets shown.
...
| 14 | `old-gods` | 1 | 61 |  | `seven-kingdoms` / WORSHIPS / Old gods (track_b: Religion) |
| 15 | `dragonpit` | 6 | 60 |  | `burning-knight` / DIED_AT / Dragonpit (track_b: Died) |
| 16 | `drogon` | 1 | 58 |  | `dreamfyre` / PARENT_OF / Drogon (track_b: Issue) |
| 17 | `alicent-hightower` | 3 | 57 |  | `aegon-ii-targaryen` / PARENT_OF / Alicent Hightower |
| 18 | `maegors-holdfast` | 3 | 56 |  | `aegon-targaryen-son-of-rhaegar` / DIED_AT / Maegor's Holdfast (qualifier: supposedly) |
| 19 | `kingswood` | 3 | 55 |  | `simon-toyne` / DIED_AT / Kingswood (track_b: Died) |
| 20 | `haunted-forest` | 2 | 55 |  | `clubfoot-karl` / DIED_AT / Haunted forest (track_b: Died) |
| 21 | `jacaerys-velaryon` | 3 | 54 |  | `rhaenyra-targaryen` / HEIR_TO / Jacaerys Velaryon |
| 22 | `starry-sept` | 3 | 53 |  | `high-lickspittle` / DIED_AT / Starry Sept (track_b: Died) |
| 23 | `disputed-lands` | 6 | 52 |  | `aegor-rivers` / DIED_AT / Disputed Lands (track_b: Died) |
| 24 | `eustace-osgrey` | 4 | 51 |  | `addam-osgrey` / PARENT_OF / Eustace Osgrey |
| 25 | `blackwater-bay` | 6 | 50 |  | `allard-seaworth` / DIED_AT / Blackwater Bay (track_b: Died) |
| 26 | `aerys-i-targaryen` | 5 | 50 |  | `aelinor-penrose` / SPOUSE_OF / Aerys I Targaryen |
| 27 | `neck` | 3 | 50 |  | `coming-of-the-andals` / DEFEATS / Neck |
| 28 | `blackfyre` | 2 | 50 |  | `war-of-the-ninepenny-kings` / DEFEATS / Blackfyre |
| 29 | `red-mountains` | 1 | 50 |  | `vulture-king-jaehaerys-i` / DIED_AT / Red Mountains (track_b: Died) |
| 30 | `house-blackwood` | 29 | 46 |  | `agnes-blackwood` / SWORN_TO / House Blackwood |
| 31 | `iron-bank-of-braavos` | 2 | 46 |  | `noho-dimittis` / SWORN_TO / Iron Bank of Braavos |
| 32 | `house-bracken` | 23 | 45 |  | `aegor-rivers` / SWORN_TO / House Bracken |
| 33 | `wolfswood` | 2 | 45 |  | `harwood-fell` / DIED_AT / Wolfswood (track_b: Died) |
| 34 | `sunset-sea` | 1 | 45 |  | `norman-hightower` / DIED_AT / Sunset Sea (track_b: Died) |
| 35 | `mountains-of-the-moon` | 12 | 44 |  | `chiggen` / DIED_AT / Mountains of the Moon (track_b: Died) |
| 36 | `fair-isle` | 6 | 44 |  | `arron` / BORN_AT / Fair Isle |
| 37 | `stoney-sept` | 5 | 44 |  | `denys-arryn` / DIED_AT / Stoney Sept |
| 38 | `131-ac` | 1 | 44 |  | `aegon-ii-targaryen` / HEIR_TO / 131 AC (track_b: Heirs) |
| 39 | `queens-men` | 18 | 43 |  | `alester-florent` / SWORN_TO / Queen's men |
| 40 | `134-ac` | 1 | 43 |  | `aegon-iii-targaryen` / HEIR_TO / 134 AC (track_b: Heirs) |
| 41 | `ormund-hightower` | 5 | 42 |  | `bethany-hightower` / PARENT_OF / Ormund Hightower |
| 42 | `old-wyk` | 6 | 41 |  | `baelor-blacktyde` / DIED_AT / Old Wyk (track_b: Died) |
| 43 | `crossroads-inn` | 1 | 39 |  | `wat-orphan` / SWORN_TO / Crossroads inn |
| 44 | `rohanne-webber` | 7 | 38 |  | `gerold-lannister` / SPOUSE_OF / Rohanne Webber |
| 45 | `tarth` | 6 | 37 |  | `aemon-targaryen-son-of-jaehaerys-i` / DIED_AT / Tarth |
| 46 | `dornish-marches` | 4 | 36 |  | `anguy` / BORN_AT / Dornish Marches |
| 47 | `laenor-velaryon` | 4 | 36 |  | `alyn-velaryon` / PARENT_OF / Laenor Velaryon (track_b: Fathers) |
| 48 | `three-sisters` | 4 | 36 |  | `lark` / BORN_AT / Three Sisters |
| 49 | `dothraki-sea` | 19 | 35 |  | `caggo` / BORN_AT / Dothraki Sea |
| 50 | `house-rogare` | 12 | 35 |  | `drako-rogare` / SWORN_TO / House Rogare |
| 51 | `joffrey-velaryon` | 3 | 35 |  | `rhaenyra-targaryen` / HEIR_TO / Joffrey Velaryon |
| 52 | `addam-velaryon` | 1 | 35 |  | `corlys-velaryon` / PARENT_OF / Addam Velaryon (track_b: Issue) |
| 53 | `great-council` | 1 | 35 |  | `maekar-i-targaryen` / HEIR_TO / Great Council |
| 54 | `khal` | 20 | 34 | yes | `cohollo` / SWORN_TO / Khal |
| 55 | `house-darry` | 16 | 34 |  | `damon-darry` / SWORN_TO / House Darry |
| 56 | `century-of-blood` | 3 | 34 |  | `agnes-blackwood` / DIED_AT / Century of Blood |
| 57 | `great-pyramid` | 1 | 34 |  | `house-targaryen` / SEAT_OF / Great Pyramid |
| 58 | `tower-of-the-hand` | 1 | 34 |  | `jaehaerys-targaryen-son-of-aegon-ii` / DIED_AT / Tower of the Hand (track_b: Died) |
| 59 | `house-florent` | 18 | 33 |  | `aladore-florent` / SWORN_TO / House Florent |
| 60 | `summer-isles` | 16 | 33 |  | `bellegere-otherys` / PARENT_OF / Summer Isles |
| 61 | `crackclaw-point` | 5 | 33 |  | `dick-crabb` / BORN_AT / Crackclaw Point |
| 62 | `dragons` | 1 | 32 |  | `dance-of-the-dragons` / DEFEATS / dragons |
| 63 | `fingers` | 5 | 31 |  | `petyr-baelish` / BORN_AT / Fingers (track_b: Born) |
| 64 | `shae` | 3 | 31 |  | `tyrion-lannister` / LOVER_OF / Shae |
| 65 | `torrhen-manderly` | 1 | 31 |  | `desmond-manderly` / PARENT_OF / Torrhen Manderly |
| 66 | `flea-bottom` | 4 | 30 |  | `clayton-suggs` / BORN_AT / Flea Bottom |
| 67 | `faircastle` | 3 | 30 |  | `alester-wynch` / DIED_AT / Faircastle (track_b: Died) |
| 68 | `lucerys-velaryon` | 2 | 30 |  | `rhaenyra-targaryen` / PARENT_OF / Lucerys Velaryon |
| 69 | `crypt-of-winterfell` | 14 | 29 |  | `barthogan-stark` / BURIED_AT / Crypt of Winterfell |
| 70 | `runestone` | 6 | 29 |  | `andar-royce` / BORN_AT / Runestone |
| 71 | `house-durrandon` | 5 | 29 |  | `argella-durrandon` / SWORN_TO / House Durrandon |
| 72 | `daznaks-pit` | 1 | 29 |  | `yurkhaz-zo-yunzak` / DIED_AT / Daznak's Pit (track_b: Died) |
| 73 | `ruby-ford` | 1 | 29 |  | `rhaegar-targaryen` / DIED_AT / Ruby Ford (track_b: Died) |
| 74 | `rhoynar` | 11 | 28 |  | `druselka` / SWORN_TO / Rhoynar |
| 75 | `robert-baratheon` | 6 | 28 |  | `becca` / LOVER_OF / Robert Baratheon |
| 76 | `jason-lannister` | 10 | 27 |  | `alys-stackspear` / SPOUSE_OF / Jason Lannister |
| 77 | `lords-declarant` | 7 | 27 |  | `anya-waynwood` / SWORN_TO / Lords Declarant |
| 78 | `house-cerwyn` | 6 | 27 |  | `argelle-stark` / SWORN_TO / House Cerwyn |
| 79 | `jeyne-arryn` | 4 | 27 |  | `arnold-arryn` / OPPOSES / Jeyne Arryn (wiki:Arnold_Arryn) |
| 80 | `green-fork` | 3 | 27 |  | `conn` / DIED_AT / Green Fork (track_b: Died) |
| 81 | `thenns` | 2 | 27 |  | `alys-karstark` / SPOUSE_OF / Thenns |
| 82 | `lady-forlorn` | 1 | 27 |  | `house-corbray` / ANCESTRAL_WEAPON_OF / Lady Forlorn |
| 83 | `bear-island` | 9 | 26 |  | `alysane-mormont` / BORN_AT / Bear Island (track_b: Born) |
| 84 | `giants-lance` | 4 | 26 |  | `artys-i-arryn` / BORN_AT / Giant's Lance |
| 85 | `silent-sisters` | 4 | 26 |  | `alysanne-osgrey` / SWORN_TO / Silent Sisters |
| 86 | `arlan-of-pennytree` | 1 | 26 |  | `chestnut` / OWNS / Arlan of Pennytree |
| 87 | `paramour` | 1 | 26 |  | `ellaria-sand` / LOVER_OF / paramour (track_b: Lover) |
| 88 | `ship` | 1 | 26 |  | `quence` / SWORN_TO / Ship |
| 89 | `larys-strong` | 1 | 25 |  | `hour-of-the-wolf` / DEFEATS / Larys Strong |
| 90 | `house-gardener` | 10 | 24 |  | `alester-tyrell` / SWORN_TO / House Gardener |
| 91 | `stormcrows` | 7 | 24 |  | `daario-naharis` / SWORN_TO / Stormcrows |
| 92 | `oldstones` | 5 | 24 |  | `merrett-frey` / DIED_AT / Oldstones (track_b: Died) |
| 93 | `shipbreaker-bay` | 3 | 24 |  | `arrax` / DIED_AT / Shipbreaker Bay (track_b: Died) |
| 94 | `house-of-black-and-white` | 2 | 24 |  | `umma` / SWORN_TO / House of Black and White |
| 95 | `299-ac` | 1 | 24 |  | `house-bolton` / OVERLORD_OF / 299 AC (track_b: Overlords) |
| 96 | `betrothal` | 1 | 24 |  | `lyonel-baratheons-rebellion` / DEFEATS / Betrothal |
| 97 | `house-hornwood` | 7 | 23 |  | `berena-hornwood` / SWORN_TO / House Hornwood |
| 98 | `house-dustin` | 6 | 23 |  | `barbrey-dustin` / SWORN_TO / House Dustin |
| 99 | `shield-islands` | 4 | 23 |  | `talbert-serry` / DIED_AT / Shield Islands (track_b: Died) |
| 100 | `marwyn` | 1 | 23 |  | `qyburn` / RESPECTS / Marwyn |

_(Long tail: 1259 additional missing targets. See `working/audits/orphan-edges-2026-04-30d-cat1-full.tsv` for the complete list.)_
