# Orphan Edges Audit — 2026-05-02-pathb-final

**Nodes scanned:** 7562
**Total edges checked:** 21026
**Edges that resolve cleanly:** 18730
**Orphan / problematic edges found:** 2296

**Breakdown:**
- Category 1 (target genuinely missing): 1963 edges across 821 unique missing targets
- Category 2 (alias-mismatch — resolves via alias-resolver): 291 edges across 33 unique alias slugs
...
Sorted by `in_count` desc, then by edge_count. Top 100 of 821 unique missing targets shown.
...
| 30 | `winter-wolves` | 1 | 12 |  | `roderick-dustin` / SWORN_TO / Winter Wolves |
| 31 | `chatayas-brothel` | 6 | 11 |  | `alayaya` / SWORN_TO / Chataya's brothel |
| 32 | `happy-port` | 6 | 10 |  | `assadora` / SWORN_TO / Happy Port |
| 33 | `kings-men` | 5 | 10 |  | `andrew-estermont` / SWORN_TO / King's men |
| 34 | `the-wall` | 1 | 10 |  | `harma-dogshead` / DIED_AT / The Wall (track_b: Died) |
| 35 | `king-s-landing` | 1 | 9 |  | `bramm-of-blackhull` / DIED_AT / King’s Landing (track_b: Died) |
| 36 | `kings-of-the-reach` | 1 | 9 |  | `order-of-the-green-hand` / SWORN_TO / Kings of the Reach |
| 37 | `tommen-i-baratheon` | 7 | 8 |  | `boots` / OWNS / Tommen I Baratheon |
| 38 | `battle-of-the-red-fork` | 1 | 8 |  | `daven-lannister` / FIGHTS_IN / Battle of the Red Fork |
| 39 | `frozen-shore` | 1 | 8 |  | `great-walrus` / BORN_AT / Frozen Shore |
| 40 | `storm-kings` | 1 | 8 |  | `battle-of-six-kings` / DEFEATS / Storm Kings |
| 41 | `the-gate` | 1 | 8 |  | `izembaro` / SWORN_TO / The Gate |
| 42 | `house-flint` | 3 | 7 |  | `byam-flint` / SWORN_TO / House Flint |
| 43 | `iron-bank` | 1 | 7 |  | `bessaro-reyaan` / SWORN_TO / Iron Bank |
| 44 | `lady-of-coldmoat` | 1 | 7 | yes | `rohanne-webber` / HOLDS_TITLE / Lady of Coldmoat |
| 45 | `lord-paramount-of-the-mander` | 8 | 6 | yes | `bertrand-tyrell` / HOLDS_TITLE / Lord Paramount of the Mander |
| 46 | `bastards-boys` | 3 | 6 |  | `grunt` / SWORN_TO / Bastard's Boys |
| 47 | `house-fossoway` | 3 | 6 |  | `derrick-fossoway` / SWORN_TO / House Fossoway |
| 48 | `valyrian-peninsula` | 1 | 6 |  | `aurion` / DIED_AT / Valyrian peninsula (track_b: Died) |
| 49 | `wedding-of-aegon-iii-targaryen-and-jaehaera-targaryen` | 1 | 6 |  | `dance-of-the-dragons` / DEFEATS / Wedding of Aegon III Targaryen and Jaehaera Targaryen |
| 50 | `yunkish` | 1 | 6 |  | `crunch` / DIED_AT / Yunkish (track_b: Died) |
| 51 | `artys-arryn` | 3 | 5 |  | `robar-ii-royce` / SUCCEEDS / Artys Arryn |
| 52 | `drowned-men` | 3 | 5 |  | `emmond` / SWORN_TO / Drowned men |
| 53 | `battle-of-stonebridge` | 1 | 5 |  | `faith-militant-uprising` / FIGHTS_IN / Battle of Stonebridge |
| 54 | `lady-of-the-eyrie` | 1 | 5 | yes | `jeyne-arryn` / HOLDS_TITLE / Lady of the Eyrie |
| 55 | `motherhouse-of-maris` | 1 | 5 |  | `jeyne-arryn` / DIED_AT / Motherhouse of Maris (track_b: Died) |
| 56 | `elephants` | 3 | 4 |  | `doniphos-paenymion` / SWORN_TO / Elephants |
| 57 | `last-greenseer` | 3 | 4 |  | `ash` / SWORN_TO / last greenseer |
| 58 | `battle-at-the-mander` | 1 | 4 |  | `roberts-rebellion` / FIGHTS_IN / Battle at the Mander |
| 59 | `battle-of-the-green-fork` | 1 | 4 |  | `bronn` / FIGHTS_IN / Battle of the Green Fork |
| 60 | `battle-of-the-whispering-wood` | 1 | 4 |  | `jaime-lannister` / FIGHTS_IN / Battle of the Whispering Wood |
| 61 | `pyntos` | 1 | 4 |  | `pynto` / SWORN_TO / Pynto's |
| 62 | `free-company` | 1 | 3 |  | `howard-bullock` / SWORN_TO / Free Company |
| 63 | `old-palace` | 1 | 3 |  | `house-martell` / SEAT_OF / Old Palace |
| 64 | `conflict-beyond-the-wall` | 6 | 2 |  | `attack-on-castle-black` / FIGHTS_IN / Conflict beyond the Wall |
| 65 | `great-hall` | 3 | 2 |  | `aerys-ii-targaryen` / DIED_AT / Great Hall (track_b: Died) |
| 66 | `daemon-blackfyre` | 1 | 2 |  | `house-blackfyre` / FOUNDED / Daemon Blackfyre |
| 67 | `kingdom-of-the-three-daughters` | 1 | 2 |  | `racallio-ryndoon` / SWORN_TO / Kingdom of the Three Daughters |
| 68 | `sarnori` | 1 | 2 |  | `mazor-alexi` / CULTURE_OF / Sarnori |
| 69 | `silent-sister` | 1 | 2 |  | `maris-baratheon` / HOLDS_TITLE / Silent sister |
| 70 | `lannister` | 15 | 1 |  | `battle-at-the-mummers-ford` / DEFEATS / Lannister |
| 71 | `the-vale` | 9 | 1 |  | `roland-i-arryn` / DIED_AT / the Vale |
| 72 | `cerelle-lannister` | 6 | 1 |  | `gerold-lannister` / SUCCEEDS / Cerelle Lannister |
| 73 | `drogos-khalasar` | 4 | 1 |  | `drogo` / SWORN_TO / Drogo's khalasar |
| 74 | `2-bc` | 3 | 1 |  | `house-baratheon` / OVERLORD_OF / 2 BC (track_b: Overlords) |
| 75 | `thenn` | 3 | 1 |  | `sigorn` / BORN_AT / Thenn |
| 76 | `aegon-ii` | 1 | 1 |  | `dance-of-the-dragons` / DEFEATS / Aegon II |
| 77 | `aegon-iii` | 1 | 1 |  | `dance-of-the-dragons` / DEFEATS / Aegon III |
| 78 | `aegon-vi-targaryen` | 1 | 1 |  | `varys` / SWORN_TO / Aegon VI Targaryen |
| 79 | `blackfyre-rebellions` | 1 | 1 |  | `second-blackfyre-rebellion` / FIGHTS_IN / Blackfyre Rebellions |
| 80 | `house-farwynd` | 1 | 1 |  | `triston-farwynd` / SWORN_TO / House Farwynd |
| 81 | `joffrey-lydden` | 1 | 1 |  | `gerold-iii-lannister` / SUCCEEDS / Joffrey Lydden |
| 82 | `lord-caswell` | 1 | 1 |  | `lady-caswell` / SPOUSE_OF / Lord Caswell |
| 83 | `lord-commander` | 1 | 1 |  | `mutiny-at-castle-black` / DEFEATS / Lord Commander |
| 84 | `rhaenyra` | 1 | 1 |  | `dance-of-the-dragons` / DEFEATS / Rhaenyra |
| 85 | `sabitha-vypren` | 1 | 1 |  | `forrest-frey` / SPOUSE_OF / Sabitha Vypren |
| 86 | `sea-watch` | 1 | 1 |  | `tristimun` / MEMBER_OF / Sea watch |
| 87 | `unknown` | 321 | 0 |  | `addam-hightower` / SPOUSE_OF / Unknown |
| 88 | `the-citadel` | 83 | 0 |  | `abelon` / SWORN_TO / The Citadel |
| 89 | `extinct` | 37 | 0 |  | `house-amber` / RULES / Extinct |
| 90 | `son` | 31 | 0 |  | `alyn-tarbeck` / PARENT_OF / Son |
| 91 | `none` | 29 | 0 |  | `aerys-i-targaryen` / PARENT_OF / None |
| 92 | `sons` | 27 | 0 |  | `antario-jast` / PARENT_OF / Sons |
| 93 | `daughter` | 26 | 0 |  | `alysane-mormont` / PARENT_OF / Daughter |
| 94 | `captain` | 20 | 0 | yes | `alvyn-sharp` / HOLDS_TITLE / Captain |
| 95 | `commander` | 13 | 0 |  | `bedwyck` / HOLDS_TITLE / Commander |
| 96 | `daughters` | 8 | 0 |  | `choq-choq` / PARENT_OF / Daughters |
| 97 | `two-daughters` | 8 | 0 |  | `corwyn-corbray` / PARENT_OF / Two daughters |
| 98 | `unborn-child` | 8 | 0 |  | `alyce-graceford` / PARENT_OF / Unborn child |
| 99 | `gate` | 7 | 0 |  | `big-brusco` / SWORN_TO / Gate |
| 100 | `deceased-husband` | 6 | 0 |  | `anya-waynwood` / SPOUSE_OF / Deceased husband |

_(Long tail: 721 additional missing targets. See `working/audits/orphan-edges-2026-05-02-pathb-final-cat1-full.tsv` for the complete list.)_

---

## Category 2: alias-mismatch (resolvable via alias-resolver)

These targets fail direct slug-match but DO resolve via the alias-resolver. **291 edges across 33 unique alias slugs** are affected.
...
Of 21026 edges across 7562 nodes, 18730 resolve cleanly. 2296 are orphan or stale, dominated by Cat 1 (1963 edges, 821 unique slugs). Date-bleed status: 42 stragglers remain. Religion-bleed leftovers: 0. Title-like targets are a structural gap: 24 title slugs referenced by 51 edges with no node. Cat 2 alias-mismatches (291 edges) are not gaps — they're handled the moment the graph layer consults `working/wiki-parsed/alias-resolver.json` after a direct-slug miss.
...
4. **MED — Wire alias-resolver into the graph query layer.** All 291 Cat 2 mismatches resolve once lookup consults `alias-resolver.json` on direct-slug miss. Avoids touching 33 source nodes.
