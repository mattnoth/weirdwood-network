# Orphan Edges Audit — 2026-04-30b

**Nodes scanned:** 4706
**Total edges checked:** 18635
**Edges that resolve cleanly:** 13250
**Orphan / problematic edges found:** 5385

**Breakdown:**
- Category 1 (target genuinely missing): 5274 edges across 1411 unique missing targets
...
Sorted by `in_count` desc, then by edge_count. Top 100 of 1411 unique missing targets shown.
...
| 12 | `northmen` | 261 | 63 |  | `alaric-stark` / CULTURE_OF / Northmen |
| 13 | `129-ac` | 1 | 63 |  | `aegon-ii-targaryen` / HEIR_TO / 129 AC (track_b: Heirs) |
| 14 | `andals` | 3 | 62 |  | `argos-sevenstar` / CULTURE_OF / Andals |
| 15 | `house-manderly` | 23 | 61 |  | `bartimus` / SWORN_TO / House Manderly |
| 16 | `old-gods` | 1 | 61 |  | `seven-kingdoms` / WORSHIPS / Old gods (track_b: Religion) |
| 17 | `dragonpit` | 6 | 60 |  | `burning-knight` / DIED_AT / Dragonpit (track_b: Died) |
| 18 | `drogon` | 1 | 58 |  | `dreamfyre` / PARENT_OF / Drogon (track_b: Issue) |
| 19 | `alicent-hightower` | 3 | 57 |  | `aegon-ii-targaryen` / PARENT_OF / Alicent Hightower |
| 20 | `maegors-holdfast` | 3 | 56 |  | `aegon-targaryen-son-of-rhaegar` / DIED_AT / Maegor's Holdfast (qualifier: supposedly) |
| 21 | `kingswood` | 3 | 55 |  | `simon-toyne` / DIED_AT / Kingswood (track_b: Died) |
| 22 | `haunted-forest` | 2 | 55 |  | `clubfoot-karl` / DIED_AT / Haunted forest (track_b: Died) |
| 23 | `jacaerys-velaryon` | 3 | 54 |  | `rhaenyra-targaryen` / HEIR_TO / Jacaerys Velaryon |
| 24 | `starry-sept` | 3 | 53 |  | `high-lickspittle` / DIED_AT / Starry Sept (track_b: Died) |
| 25 | `disputed-lands` | 6 | 52 |  | `aegor-rivers` / DIED_AT / Disputed Lands (track_b: Died) |
| 26 | `children-of-the-forest` | 4 | 51 |  | `ash` / CULTURE_OF / children of the forest |
| 27 | `eustace-osgrey` | 4 | 51 |  | `addam-osgrey` / PARENT_OF / Eustace Osgrey |
| 28 | `blackwater-bay` | 6 | 50 |  | `allard-seaworth` / DIED_AT / Blackwater Bay (track_b: Died) |
| 29 | `aerys-i-targaryen` | 5 | 50 |  | `aelinor-penrose` / SPOUSE_OF / Aerys I Targaryen |
| 30 | `neck` | 3 | 50 |  | `coming-of-the-andals` / DEFEATS / Neck |
| 31 | `blackfyre` | 2 | 50 |  | `war-of-the-ninepenny-kings` / DEFEATS / Blackfyre |
| 32 | `red-mountains` | 1 | 50 |  | `vulture-king-jaehaerys-i` / DIED_AT / Red Mountains (track_b: Died) |
| 33 | `house-blackwood` | 29 | 46 |  | `agnes-blackwood` / SWORN_TO / House Blackwood |
| 34 | `iron-bank-of-braavos` | 2 | 46 |  | `noho-dimittis` / SWORN_TO / Iron Bank of Braavos |
| 35 | `giants` | 1 | 46 |  | `mag-mar-tun-doh-weg` / CULTURE_OF / Giants |
| 36 | `house-bracken` | 23 | 45 |  | `aegor-rivers` / SWORN_TO / House Bracken |
| 37 | `wolfswood` | 2 | 45 |  | `harwood-fell` / DIED_AT / Wolfswood (track_b: Died) |
| 38 | `sunset-sea` | 1 | 45 |  | `norman-hightower` / DIED_AT / Sunset Sea (track_b: Died) |
| 39 | `mountains-of-the-moon` | 12 | 44 |  | `chiggen` / DIED_AT / Mountains of the Moon (track_b: Died) |
| 40 | `fair-isle` | 6 | 44 |  | `arron` / BORN_AT / Fair Isle |
| 41 | `stoney-sept` | 5 | 44 |  | `denys-arryn` / DIED_AT / Stoney Sept |
| 42 | `131-ac` | 1 | 44 |  | `aegon-ii-targaryen` / HEIR_TO / 131 AC (track_b: Heirs) |
| 43 | `queens-men` | 18 | 43 |  | `alester-florent` / SWORN_TO / Queen's men |
| 44 | `134-ac` | 1 | 43 |  | `aegon-iii-targaryen` / HEIR_TO / 134 AC (track_b: Heirs) |
| 45 | `vale-mountain-clans` | 17 | 42 |  | `calor` / CULTURE_OF / Vale mountain clans |
| 46 | `ormund-hightower` | 5 | 42 |  | `bethany-hightower` / PARENT_OF / Ormund Hightower |
| 47 | `old-wyk` | 6 | 41 |  | `baelor-blacktyde` / DIED_AT / Old Wyk (track_b: Died) |
| 48 | `crossroads-inn` | 1 | 39 |  | `wat-orphan` / SWORN_TO / Crossroads inn |
| 49 | `rohanne-webber` | 7 | 38 |  | `gerold-lannister` / SPOUSE_OF / Rohanne Webber |
| 50 | `tarth` | 6 | 37 |  | `aemon-targaryen-son-of-jaehaerys-i` / DIED_AT / Tarth |
| 51 | `dornish-marches` | 4 | 36 |  | `anguy` / BORN_AT / Dornish Marches |
| 52 | `laenor-velaryon` | 4 | 36 |  | `alyn-velaryon` / PARENT_OF / Laenor Velaryon (track_b: Fathers) |
| 53 | `three-sisters` | 4 | 36 |  | `lark` / BORN_AT / Three Sisters |
| 54 | `andal` | 53 | 35 |  | `alester-tyrell` / CULTURE_OF / Andal |
| 55 | `dothraki-sea` | 19 | 35 |  | `caggo` / BORN_AT / Dothraki Sea |
| 56 | `house-rogare` | 12 | 35 |  | `drako-rogare` / SWORN_TO / House Rogare |
| 57 | `joffrey-velaryon` | 3 | 35 |  | `rhaenyra-targaryen` / HEIR_TO / Joffrey Velaryon |
| 58 | `addam-velaryon` | 1 | 35 |  | `corlys-velaryon` / PARENT_OF / Addam Velaryon (track_b: Issue) |
| 59 | `great-council` | 1 | 35 |  | `maekar-i-targaryen` / HEIR_TO / Great Council |
| 60 | `khal` | 20 | 34 | yes | `cohollo` / SWORN_TO / Khal |
| 61 | `house-darry` | 16 | 34 |  | `damon-darry` / SWORN_TO / House Darry |
| 62 | `century-of-blood` | 3 | 34 |  | `agnes-blackwood` / DIED_AT / Century of Blood |
| 63 | `great-pyramid` | 1 | 34 |  | `house-targaryen` / SEAT_OF / Great Pyramid |
| 64 | `tower-of-the-hand` | 1 | 34 |  | `jaehaerys-targaryen-son-of-aegon-ii` / DIED_AT / Tower of the Hand (track_b: Died) |
| 65 | `westermen` | 223 | 33 |  | `addam-marbrand` / CULTURE_OF / Westermen |
| 66 | `house-florent` | 18 | 33 |  | `aladore-florent` / SWORN_TO / House Florent |
| 67 | `summer-isles` | 16 | 33 |  | `bellegere-otherys` / PARENT_OF / Summer Isles |
| 68 | `crackclaw-point` | 5 | 33 |  | `dick-crabb` / BORN_AT / Crackclaw Point |
| 69 | `crannogmen` | 5 | 32 |  | `howland-reed` / CULTURE_OF / Crannogmen |
| 70 | `dragons` | 1 | 32 |  | `dance-of-the-dragons` / DEFEATS / dragons |
| 71 | `rivermen` | 415 | 31 |  | `addam-frey` / CULTURE_OF / Rivermen |
| 72 | `fingers` | 5 | 31 |  | `petyr-baelish` / BORN_AT / Fingers (track_b: Born) |
| 73 | `shae` | 3 | 31 |  | `tyrion-lannister` / LOVER_OF / Shae |
| 74 | `torrhen-manderly` | 1 | 31 |  | `desmond-manderly` / PARENT_OF / Torrhen Manderly |
| 75 | `flea-bottom` | 4 | 30 |  | `clayton-suggs` / BORN_AT / Flea Bottom |
| 76 | `faircastle` | 3 | 30 |  | `alester-wynch` / DIED_AT / Faircastle (track_b: Died) |
| 77 | `lucerys-velaryon` | 2 | 30 |  | `rhaenyra-targaryen` / PARENT_OF / Lucerys Velaryon |
| 78 | `crypt-of-winterfell` | 14 | 29 |  | `barthogan-stark` / BURIED_AT / Crypt of Winterfell |
| 79 | `runestone` | 6 | 29 |  | `andar-royce` / BORN_AT / Runestone |
| 80 | `house-durrandon` | 5 | 29 |  | `argella-durrandon` / SWORN_TO / House Durrandon |
| 81 | `daznaks-pit` | 1 | 29 |  | `yurkhaz-zo-yunzak` / DIED_AT / Daznak's Pit (track_b: Died) |
| 82 | `ruby-ford` | 1 | 29 |  | `rhaegar-targaryen` / DIED_AT / Ruby Ford (track_b: Died) |
| 83 | `rhoynar` | 11 | 28 |  | `druselka` / SWORN_TO / Rhoynar |
| 84 | `robert-baratheon` | 6 | 28 |  | `becca` / LOVER_OF / Robert Baratheon |
| 85 | `ironmen` | 1 | 28 |  | `theon-greyjoy` / CULTURE_OF / Ironmen |
| 86 | `jason-lannister` | 10 | 27 |  | `alys-stackspear` / SPOUSE_OF / Jason Lannister |
| 87 | `lords-declarant` | 7 | 27 |  | `anya-waynwood` / SWORN_TO / Lords Declarant |
| 88 | `house-cerwyn` | 6 | 27 |  | `argelle-stark` / SWORN_TO / House Cerwyn |
| 89 | `jeyne-arryn` | 4 | 27 |  | `arnold-arryn` / OPPOSES / Jeyne Arryn (wiki:Arnold_Arryn) |
| 90 | `green-fork` | 3 | 27 |  | `conn` / DIED_AT / Green Fork (track_b: Died) |
| 91 | `thenns` | 2 | 27 |  | `alys-karstark` / SPOUSE_OF / Thenns |
| 92 | `lady-forlorn` | 1 | 27 |  | `house-corbray` / ANCESTRAL_WEAPON_OF / Lady Forlorn |
| 93 | `ghiscari` | 60 | 26 |  | `azzak-zo-ghazeen` / CULTURE_OF / Ghiscari |
| 94 | `bear-island` | 9 | 26 |  | `alysane-mormont` / BORN_AT / Bear Island (track_b: Born) |
| 95 | `giants-lance` | 4 | 26 |  | `artys-i-arryn` / BORN_AT / Giant's Lance |
| 96 | `silent-sisters` | 4 | 26 |  | `alysanne-osgrey` / SWORN_TO / Silent Sisters |
| 97 | `arlan-of-pennytree` | 1 | 26 |  | `chestnut` / OWNS / Arlan of Pennytree |
| 98 | `paramour` | 1 | 26 |  | `ellaria-sand` / LOVER_OF / paramour (track_b: Lover) |
| 99 | `ship` | 1 | 26 |  | `quence` / SWORN_TO / Ship |
| 100 | `northern-mountain-clans` | 16 | 25 |  | `arra-norrey` / CULTURE_OF / Northern mountain clans |

_(Long tail: 1311 additional missing targets. See `working/audits/orphan-edges-2026-04-30b-cat1-full.tsv` for the complete list.)_
