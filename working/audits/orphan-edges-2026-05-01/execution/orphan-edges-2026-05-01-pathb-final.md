# Orphan Edges Audit — 2026-05-01-pathb-final

**Nodes scanned:** 6876
**Total edges checked:** 21027
**Edges that resolve cleanly:** 18672
**Orphan / problematic edges found:** 2355

**Breakdown:**
- Category 1 (target genuinely missing): 2021 edges across 849 unique missing targets
...
- Title-like missing targets (subset of Cat 1): 52 edges, 25 unique title slugs
...
**25 unique title slugs referenced; 52 total edge references.**
...
Sorted by `in_count` desc, then by edge_count. Top 100 of 849 unique missing targets shown.
...
| 15 | `lords-declarant` | 7 | 27 |  | `anya-waynwood` / SWORN_TO / Lords Declarant |
| 16 | `silent-sisters` | 4 | 26 |  | `alysanne-osgrey` / SWORN_TO / Silent Sisters |
| 17 | `ship` | 2 | 26 |  | `allaquo` / SWORN_TO / Ship |
| 18 | `299-ac` | 1 | 24 |  | `house-bolton` / OVERLORD_OF / 299 AC (track_b: Overlords) |
| 19 | `betrothal` | 1 | 24 |  | `lyonel-baratheons-rebellion` / DEFEATS / Betrothal |
| 20 | `joffrey-i-baratheon` | 2 | 22 |  | `robert-i-baratheon` / SUCCEEDS / Joffrey I Baratheon |
| 21 | `queen-of-love-and-beauty` | 1 | 22 | yes | `lord-ashfords-daughter` / HOLDS_TITLE / Queen of Love and Beauty |
| 22 | `vale` | 5 | 21 |  | `battle-in-the-waters-off-gulltown` / DEFEATS / Vale |
| 23 | `two-betrayers` | 2 | 21 |  | `hugh-hammer` / SWORN_TO / Two Betrayers |
| 24 | `cinnamon-wind` | 2 | 19 |  | `aemon-targaryen-son-of-maekar-i` / DIED_AT / Cinnamon Wind |
| 25 | `tower-of-joy` | 1 | 18 |  | `roberts-rebellion` / FIGHTS_IN / Tower of joy |
| 26 | `andal-invasion` | 3 | 17 |  | `battle-of-the-seven-stars` / FIGHTS_IN / Andal invasion |
| 27 | `lads` | 3 | 16 |  | `alysanne-blackwood` / SWORN_TO / Lads |
| 28 | `282-ac` | 1 | 16 |  | `house-baratheon` / OVERLORD_OF / 282 AC (track_b: Overlords) |
| 29 | `moon-of-the-three-kings` | 1 | 16 |  | `riot-of-kings-landing-dance-of-the-dragons` / DEFEATS / Moon of the Three Kings |
| 30 | `300-ac` | 1 | 15 |  | `house-bolton` / OVERLORD_OF / 300 AC (track_b: Overlords) |
| 31 | `street-of-silk` | 1 | 15 |  | `jory-cassel` / DIED_AT / Street of Silk (track_b: Died) |
| 32 | `bridge-of-skulls` | 3 | 12 |  | `aladale-wynch` / DIED_AT / Bridge of Skulls (track_b: Died) |
| 33 | `pirates` | 2 | 12 |  | `korra` / SWORN_TO / Pirates |
| 34 | `elephant` | 1 | 12 |  | `trianna` / SWORN_TO / Elephant |
| 35 | `winter-wolves` | 1 | 12 |  | `roderick-dustin` / SWORN_TO / Winter Wolves |
| 36 | `chatayas-brothel` | 6 | 11 |  | `alayaya` / SWORN_TO / Chataya's brothel |
| 37 | `pureborn` | 4 | 11 |  | `egon-emeros` / SWORN_TO / Pureborn |
| 38 | `dosh-khaleen` | 1 | 11 |  | `one-eyed-crone` / SWORN_TO / Dosh khaleen |
| 39 | `happy-port` | 6 | 10 |  | `assadora` / SWORN_TO / Happy Port |
| 40 | `kings-men` | 5 | 10 |  | `andrew-estermont` / SWORN_TO / King's men |
| 41 | `submission-of-sunspear` | 1 | 10 |  | `conquest-of-dorne` / FIGHTS_IN / Submission of Sunspear |
| 42 | `the-wall` | 1 | 10 |  | `harma-dogshead` / DIED_AT / The Wall (track_b: Died) |
| 43 | `king-s-landing` | 1 | 9 |  | `bramm-of-blackhull` / DIED_AT / King’s Landing (track_b: Died) |
| 44 | `kings-of-the-reach` | 1 | 9 |  | `order-of-the-green-hand` / SWORN_TO / Kings of the Reach |
| 45 | `tommen-i-baratheon` | 7 | 8 |  | `boots` / OWNS / Tommen I Baratheon |
| 46 | `undying-ones` | 2 | 8 |  | `pyat-pree` / SWORN_TO / Undying Ones |
| 47 | `battle-of-the-red-fork` | 1 | 8 |  | `daven-lannister` / FIGHTS_IN / Battle of the Red Fork |
| 48 | `frozen-shore` | 1 | 8 |  | `great-walrus` / BORN_AT / Frozen Shore |
| 49 | `gate-of-the-gods` | 1 | 8 |  | `lucas-leygood` / DIED_AT / Gate of the Gods (track_b: Died) |
| 50 | `storm-kings` | 1 | 8 |  | `battle-of-six-kings` / DEFEATS / Storm Kings |
| 51 | `the-gate` | 1 | 8 |  | `izembaro` / SWORN_TO / The Gate |
| 52 | `stone-crows` | 10 | 7 |  | `conn` / SWORN_TO / Stone Crows |
| 53 | `house-flint` | 3 | 7 |  | `byam-flint` / SWORN_TO / House Flint |
| 54 | `cobblers-square` | 1 | 7 |  | `luthor-largent` / DIED_AT / Cobbler's Square (track_b: Died) |
| 55 | `iron-bank` | 1 | 7 |  | `bessaro-reyaan` / SWORN_TO / Iron Bank |
| 56 | `lady-of-coldmoat` | 1 | 7 | yes | `rohanne-webber` / HOLDS_TITLE / Lady of Coldmoat |
| 57 | `pact` | 1 | 7 |  | `coming-of-the-andals` / DEFEATS / Pact |
| 58 | `shavepates` | 1 | 7 |  | `skahaz-mo-kandaq` / SWORN_TO / Shavepates |
| 59 | `lord-paramount-of-the-mander` | 8 | 6 | yes | `bertrand-tyrell` / HOLDS_TITLE / Lord Paramount of the Mander |
| 60 | `bastards-boys` | 3 | 6 |  | `grunt` / SWORN_TO / Bastard's Boys |
| 61 | `house-fossoway` | 3 | 6 |  | `derrick-fossoway` / SWORN_TO / House Fossoway |
| 62 | `high-council-of-the-triarchy` | 1 | 6 | yes | `triarchy` / RULES / High Council of the Triarchy |
| 63 | `valyrian-peninsula` | 1 | 6 |  | `aurion` / DIED_AT / Valyrian peninsula (track_b: Died) |
| 64 | `wedding-of-aegon-iii-targaryen-and-jaehaera-targaryen` | 1 | 6 |  | `dance-of-the-dragons` / DEFEATS / Wedding of Aegon III Targaryen and Jaehaera Targaryen |
| 65 | `yunkish` | 1 | 6 |  | `crunch` / DIED_AT / Yunkish (track_b: Died) |
| 66 | `artys-arryn` | 3 | 5 |  | `robar-ii-royce` / SUCCEEDS / Artys Arryn |
| 67 | `drowned-men` | 3 | 5 |  | `emmond` / SWORN_TO / Drowned men |
| 68 | `battle-of-stonebridge` | 1 | 5 |  | `faith-militant-uprising` / FIGHTS_IN / Battle of Stonebridge |
| 69 | `lady-of-the-eyrie` | 1 | 5 | yes | `jeyne-arryn` / HOLDS_TITLE / Lady of the Eyrie |
| 70 | `motherhouse-of-maris` | 1 | 5 |  | `jeyne-arryn` / DIED_AT / Motherhouse of Maris (track_b: Died) |
| 71 | `elephants` | 3 | 4 |  | `doniphos-paenymion` / SWORN_TO / Elephants |
| 72 | `last-greenseer` | 3 | 4 |  | `ash` / SWORN_TO / last greenseer |
| 73 | `tiger` | 3 | 4 |  | `belicho` / SWORN_TO / Tiger |
| 74 | `stalwart-shields` | 2 | 4 |  | `mollono-yos-dob` / SWORN_TO / Stalwart Shields |
| 75 | `battle-at-the-mander` | 1 | 4 |  | `roberts-rebellion` / FIGHTS_IN / Battle at the Mander |
| 76 | `battle-of-the-green-fork` | 1 | 4 |  | `bronn` / FIGHTS_IN / Battle of the Green Fork |
| 77 | `battle-of-the-whispering-wood` | 1 | 4 |  | `jaime-lannister` / FIGHTS_IN / Battle of the Whispering Wood |
| 78 | `guildhall-of-the-alchemists` | 1 | 4 |  | `alchemists-guild` / SEAT_OF / Guildhall of the Alchemists |
| 79 | `lichyard` | 1 | 4 |  | `mikken` / BURIED_AT / lichyard |
| 80 | `mothers-men` | 1 | 4 |  | `marselen` / SWORN_TO / Mother's Men |
| 81 | `pyntos` | 1 | 4 |  | `pynto` / SWORN_TO / Pynto's |
| 82 | `moon-brothers` | 4 | 3 |  | `calor` / SWORN_TO / Moon Brothers |
| 83 | `burned-men` | 2 | 3 |  | `timett-father` / SWORN_TO / Burned Men |
| 84 | `free-company` | 1 | 3 |  | `howard-bullock` / SWORN_TO / Free Company |
| 85 | `oakenseat` | 1 | 3 |  | `anarchy-in-the-reach` / DEFEATS / Oakenseat |
| 86 | `old-palace` | 1 | 3 |  | `house-martell` / SEAT_OF / Old Palace |
| 87 | `wild-hares` | 1 | 3 |  | `benfred-tallhart` / SWORN_TO / Wild Hares |
| 88 | `conflict-beyond-the-wall` | 6 | 2 |  | `attack-on-castle-black` / FIGHTS_IN / Conflict beyond the Wall |
| 89 | `great-hall` | 3 | 2 |  | `aerys-ii-targaryen` / DIED_AT / Great Hall (track_b: Died) |
| 90 | `daemon-blackfyre` | 1 | 2 |  | `house-blackfyre` / FOUNDED / Daemon Blackfyre |
| 91 | `godswife` | 1 | 2 |  | `mirri-maz-duur` / HOLDS_TITLE / Godswife |
| 92 | `kingdom-of-the-three-daughters` | 1 | 2 |  | `racallio-ryndoon` / SWORN_TO / Kingdom of the Three Daughters |
| 93 | `sarnori` | 1 | 2 |  | `mazor-alexi` / CULTURE_OF / Sarnori |
| 94 | `silent-sister` | 1 | 2 |  | `maris-baratheon` / HOLDS_TITLE / Silent sister |
| 95 | `slate` | 1 | 2 |  | `house-slate` / RULES / Slate |
| 96 | `weirwood-alliance` | 1 | 2 |  | `battle-at-black-bog` / DEFEATS / Weirwood Alliance |
| 97 | `lannister` | 15 | 1 |  | `battle-at-the-mummers-ford` / DEFEATS / Lannister |
| 98 | `the-vale` | 9 | 1 |  | `roland-i-arryn` / DIED_AT / the Vale |
| 99 | `cerelle-lannister` | 6 | 1 |  | `gerold-lannister` / SUCCEEDS / Cerelle Lannister |
| 100 | `drogos-khalasar` | 4 | 1 |  | `drogo` / SWORN_TO / Drogo's khalasar |

_(Long tail: 749 additional missing targets. See `working/audits/orphan-edges-2026-05-01-pathb-final-cat1-full.tsv` for the complete list.)_
...
Of 21027 edges across 6876 nodes, 18672 resolve cleanly. 2355 are orphan or stale, dominated by Cat 1 (2021 edges, 849 unique slugs). Date-bleed status: 42 stragglers remain. Religion-bleed leftovers: 0. Title-like targets are a structural gap: 25 title slugs referenced by 52 edges with no node. Cat 2 alias-mismatches (292 edges) are not gaps — they're handled the moment the graph layer consults `working/wiki-parsed/alias-resolver.json` after a direct-slug miss.
...
5. **MED — Stand up a Title Pass.** Promote the top 25 title slugs (warden-of-the-north, lord-of-dragonstone, hand-of-the-king, ser, prince, princess, king, queen, etc.) to actual `title` nodes.
