...
**Companion docs:**
- `working/agent-fleet-specs/agent-pipeline-plan.md` — fleet roster (24 agents)
- `working/agent-fleet-specs/fleet-orchestration-plan.md` — stage DAG + stats schema + peer review
- `reference/design-philosophy.md` — Unix philosophy, single-writer-per-file, etc.
...
6. Render the status report in the format documented in working/agent-fleet-specs/fleet-runtime-architecture.md § "Monitoring skill"
