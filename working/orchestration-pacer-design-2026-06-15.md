...
> **Status:** DESIGN — for Matt's review before build. Companion to `scripts/README.md` (the per-script
> inventory) and `progress/continue-prompts/2026-06-15-script-consolidation.md` (the execution session).
