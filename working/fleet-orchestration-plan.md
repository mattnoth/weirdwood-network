...
|-------|-----------|-------|--------|
| `schema-drift-auditor` | 1 (single global pass) | full graph | `working/audits/schema-drift-<date>.md` |
| `citation-validator` | 1 | full graph | `working/audits/citation-issues-<date>.md` |
| `duplicate-detector` | 1 | full graph | `working/wiki-pass2/duplicate-candidates.jsonl` + `working/audits/duplicate-detector-stats-<date>.md` |
| `orphan-edge-finder` | 1 | full graph | `working/audits/orphan-edges-<date>.md` |
...
|-------|-----------------|--------|
| `prose-edge-reviewer` | Random 5% sample per bucket of `prose-edges/*.edges.jsonl` rows | `working/audits/prose-edge-review-<date>.md` per bucket |
| `cross-identity-reviewer` | 100% of `cross-identity-decisions.jsonl` (rarer + higher-stakes) | `working/audits/cross-identity-review-<date>.md` |
...
- `working/agent-pipeline-plan.md` — agent fleet roster (this plan adds 3 reviewers to bring total to 27)
- `working/design-philosophy.md` — Unix philosophy, soft-corrected on peer review (orchestrator-invoked sample-based review is fine; recursive-subagent peer review is not)
