...
| Sack of KL | arc/cluster | **0** | — | FLAGGED double-dip — core wired in the S133 RR pass + now the Elia-murder→Oberyn seam (S139). Off-spine side-plots remain (the wildfire, the sack's atrocities, Elia/Aegon/Rhaenys). Check overlap before picking. |
...
| Brienne → Stoneheart | arc/cluster | **0** | — | AFFC S115 spine. The last clean enrich-ready L1 arc: the Brotherhood's hangings, the Saltpans atrocity, Hyle/Pod capture, the hanging-tree choice. |
