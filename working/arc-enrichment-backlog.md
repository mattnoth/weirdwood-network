...
- **Level 1 — major arcs** = event-arcs: *Robert's Rebellion, Red Wedding, Purple Wedding, Ned's-downfall,
  ...
  Reek tangle). Next = the cheap **L2 round (B1 Frey-pies/GNC** — the Manderly Rat-Cook seed is now harvested)
  OR the remaining A2 arcs (Arya/Braavos, Tyrion-Essos, WO5K-battles).
  (These are small
