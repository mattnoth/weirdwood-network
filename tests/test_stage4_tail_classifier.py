...
class TestVocabLoading(unittest.TestCase):
    ...
    # ------------------------------------------------------------------
    # Regression: load_locked_vocab must return the canonical 170-type set,
    ...
    # S116 added SUSPECTED_OF → 168; S117 added WITNESS_IN → 169;
    # S134 added HONORED_AT → 170 (reconciled S191 2026-07-04).
    # ------------------------------------------------------------------

    def test_vocab_count_is_170(self):
        """Canonical locked vocab must contain exactly 170 types."""
        self.assertEqual(
            len(self.vocab),
            170,
            f"Expected 170 canonical types, got {len(self.vocab)}. "
